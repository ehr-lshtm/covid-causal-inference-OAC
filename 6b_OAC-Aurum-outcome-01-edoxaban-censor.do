/*=========================================================================
DO FILE NAME:			6b_OAC-Aurum-outcome-01-edoxaban-censor
...
for edoxaban only (censor at changing dose)
*=============================================================================*/
...
global filename "6b_OAC-Aurum-outcome-01-edoxaban-censor"
...
merge m:1 patid using "$pathOutOAC/`doac'_study_cohort_dose", keepusing(enddate_new) keep(master match) nogen
replace enddate = enddate_new if exposure == 1
drop enddate_new
...
save "$pathOutOAC/aurum_dose_`doac'_covariate_major_bleed", replace	
}
...
save "$pathOutOAC/aurum_dose_`doac'_covariate_`outcome'", replace	
	}
}
